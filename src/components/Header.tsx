  ...
  return (
    <header className="mainHeader">
      <nav className="mainHeader__nav">
        ...
        <div
          className={`mainHeader__pageOptions ${
            Modal ? "mainHeader__pageOptions--active" : ""
          }`}
        >
          {items.map((el) => {
            return (
              <div className="mainHeader__item">
                <a href={el.redirectTo}>{el.name}</a>
              </div>
            );
          })}
        </div>
        <div
          className={`mainHeader__burguerBtn ${
            Modal ? "mainHeader__burguerBtn--active" : ""
          }`}
          onClick={handleClick}
        >
          <span className="mainHeader__burguer1"></span>
          <span className="mainHeader__burguer2"></span>
          <span className="mainHeader__burguer3"></span>
        </div>
        <nav className="mainHeader__socialMedia">
          {facebookLink && (
